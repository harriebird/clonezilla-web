...
![GParted window](./images/disk-sda.png)
...
![Change boot order](./images/ocs-00-boot-dev-priority-bios.png)
...
![Boot manager](./images/ocs-00-boot-dev-priority-hotkey.png)
...
![Boot menu](./images/ocs-01-bootmenu.png)
...
![Sub-boot menu](./images/ocs-01-b-sub-boot-menu.png)
...
![Booting](./images/ocs-02-booting.png)

## Choose language

![Choose language](./images/ocs-03-lang.png)

## Choose keyboard layout

![Choose keyboard layout](./images/ocs-04-keymap.png)
...
![Choose Start Clonezilla](./images/ocs-05-start-clonezilla.png)

## Choose `device-image` option

![Choose device-image](./images/ocs-06-dev-img.png)
...
![Choose local_dev](./images/ocs-07-1-img-repo.png)
...
![local_dev option selected](./images/ocs-07-2-plug-and-play-dev-prompt.png)

Clonezilla will scan the disks on the machine in every few secs, and show you the results:

![Storage device scan](./images/ocs-07-3-dev-scan.png)
...
![Select sdb1 as image repository](./images/ocs-08-1-sdb1-as-img-repo.png)

Before mounting the device sdb1, it allows you to do a file system check. Here we skip it.

![Skip file system check](./images/ocs-08-1-sdb1-as-img-repo-fs-check.png)
...
![Choose directory name on sdb1](./images/ocs-08-2-sdb1-dir-list.png)
...
![Disk usage report](./images/ocs-08-3-img-repo-df.png)

Here we choose `Beginner` mode:

![Choose beginner mode](./images/ocs-08-4-beginner-expert-mode.png)

Now we can select `savedisk` option:

![Select savedisk option](./images/ocs-08-5-save-img.png)
...
![Select q2 imaging program](./images/ocs-09-advanced-param-q.png)

Then keep the default extra parameters, just press enter here:

![Select extra parameters](./images/ocs-09-advanced-param-extra.png)

By default, Clonezilla will split the image of partition to 4096 MB each volume, we accept that:

![Set image split size](./images/ocs-09-advnaced-param-split-vol.png)
:::
